export default {
  ...
  props: ["piece", "portfolioData", "musicPlaying"],
    ...
    <img @click="playSound('dist/audio/wosh.mp3'); closeLightBox()" :src='"dist/" + piece.display'/>
    ...
    <li>
    <a @click="closeLightBox(); playSound('dist/audio/swoosh.mp3')" :href='"project.php?id="+piece.id' target="_blank" :title='"Learn More About "+piece.title'>
