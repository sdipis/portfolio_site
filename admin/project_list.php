...
<body>
  ...
  <div class="listForms" id="listForms">
...
<form action="edit_profile.php" method="post">
            ...
            <input type="text" name="artstation" value="<?php echo $artstation; ?>"><br>

            <label for="codepen">CodePen:</label>
            <input type="text" name="codepen" value="<?php echo $codepen; ?>"><br>
