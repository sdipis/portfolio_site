<?php
    ...
    //permanent path declaration
    $imageFileType = strtolower(pathinfo($_FILES['uploaded']['name'], PATHINFO_EXTENSION));
    //pull extension of file
    $target_file .= '.'.$imageFileType;
    //set the file extension to the ext you pulled above
    move_uploaded_file($_FILES['uploaded']['tmp_name'], $target_file);
    //move the uploaded file to it's permanent location, temp will be deleted
