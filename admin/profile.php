...
$selectQuery = 'SELECT bio, profile_picture, cell, email, linkedin, instagram FROM users WHERE username = ?';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateQuery = 'UPDATE users SET bio = ?, profile_picture = ?, cell = ?, email = ?, linkedin = ?, instagram = ? WHERE username = ?';
    ...
    $updateStmt->bindParam(7, $username, PDO::PARAM_STR);
